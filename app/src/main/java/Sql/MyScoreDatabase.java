...
public class MyScoreDatabase
{
    ...
    private ScoreDBOpenHelper scoreDBOpenHelper;

    public MyScoreDatabase(Context context)
    {
        scoreDBOpenHelper = new ScoreDBOpenHelper(context, ScoreDBOpenHelper.DATABASE_NAME,
                null, ScoreDBOpenHelper.DATABASE_VERSION);
    ...
    {
        Cursor cursor = db.query(dataBaseScoreTable, result_columns, where, whereArgs,
